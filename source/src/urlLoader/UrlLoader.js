...
urlLoader.UrlLoader.prototype.initUI=function(){
	...
	var _d6=Flash2x.t(0,decodeURI("%E4%BB%A5%E4%B8%8B%E8%AF%B7%E6%B1%82%E8%BF%94%E5%9B%9E%E5%86%85%E5%AE%B9%EF%BC%8C%E6%98%AF%E6%89%93%E5%8D%B0%E5%9C%A8%E8%B0%83%E8%AF%95%E9%9D%A2%E6%9D%BF%E4%B8%AD%EF%BC%8C%E6%88%96%E8%87%AA%E5%8A%A8%E6%89%A7%E8%A1%8C"),18,"#006600","Arial",2,2,455.95,25.2,20,"center",false,false,"single",false);
	Flash2x.d(_d6,{x:90.05,y:870.65});
	var _d5=new urlLoader.F2xAuto_5();
	_d5.name="cssBtn";
	s.cssBtn=_d5;
	Flash2x.d(_d5,{x:268,y:684.45});
	var _d4=new urlLoader.F2xAuto_4();
	_d4.name="jsBtn";
	s.jsBtn=_d4;
	Flash2x.d(_d4,{x:268,y:634.55});
	var _d3=new urlLoader.F2xAuto_3();
	_d3.name="xmlBtn";
	s.xmlBtn=_d3;
	Flash2x.d(_d3,{x:268,y:579.6});
	var _d2=new urlLoader.F2xAuto_2();
	_d2.name="jsonBtn";
	s.jsonBtn=_d2;
	Flash2x.d(_d2,{x:268,y:515.6});
	var _d1=new urlLoader.F2xAuto_1();
	_d1.name="textBtn";
	s.textBtn=_d1;
	Flash2x.d(_d1,{x:268,y:461.65});
	var _d0=new urlLoader.F2xAuto_0();
	_d0.name="imageBtn";
	s.imageBtn=_d0;
	Flash2x.d(_d0,{x:268,y:407.7});
	s.addChild(_d0);
	s.addChild(_d1);
	s.addChild(_d2);
	s.addChild(_d3);
