...
home.Home = function () {
    ...
    s.classList.push({name: "annie.Sound", scene: "dmusic", classObj: "dmusic.Dmusic", title: "音乐播放器示例"});
    ...
    s.classList.push({name: "Flash2x.jsonp", scene: "json", classObj: "json.Json", title: "jsonp格式示例"});
