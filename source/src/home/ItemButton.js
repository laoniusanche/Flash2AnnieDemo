...
home.ItemButton.prototype.initUI=function(){
	...
	var _d0=Flash2x.t(0,decodeURI(""),32,"#FFFFFF","Arial",2,2,412.1,44.8,34,"center",false,false,"single",false);
	_d0.name="title_txt";
	s.title_txt=_d0;
	var _d1=Flash2x.s({type:0,data:"EgpFAHLIAAuWMBSLAAAIAAOWg"},{type:0,color:"#666666"},null);
	var _d2=Flash2x.s({type:0,data:"EgpFgHLMBSLAAAIAAOXMhSLAAAg"},null,{type:0,color:"#000000",lineWidth:4,caps:"round",joints:"round",miter:"10"});
