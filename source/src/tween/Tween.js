...
tween.Tween.prototype.initUI = function () {
	...
	var _d10=Flash2x.s({type:0,data:"Egsvgq/IAuBeEgrRgrKIheDaEAqjArFIgGAGEArTArFIADADEArsAqHIg5A+EAshApPIg1A4IBEA+EAq4ApXIAHAHIAtAp"},null,{type:0,color:"#444444",lineWidth:2,caps:"round",joints:"round",miter:"10"});
	Flash2x.d(_d10,{x:317.975,y:482.475});
	var _d9=Flash2x.s({type:0,data:"AguhRIBdBMIhdBWAAUhZIAKAIAAeBRIgKAJ"},null,{type:0,color:"#444444",lineWidth:1,caps:"round",joints:"round",miter:"10"});
