...
json.Json.prototype.initUI = function () {
	...
	var _d0=Flash2x.s({type:0,data:"AyVzsMAksAAAIAAFKMgksAAAgAyVjQMAksAAAIAAFIMgksAAAgAyVOjMAksAAAIAAFKMgksAAAg"},null,{type:0,color:"#000000",lineWidth:1,caps:"round",joints:"round",miter:"10"});
	...
	var _d15=new json.F2xAuto_2();
	_d15.name="switch1";
	s.switch1=_d15;
	Flash2x.d(_d15,{x:290.05,y:653.4,a:1.0007});
	var _d17=new json.F2xAuto_6();
	s.addChild(_d17);
	s.addChild(_d15);
	s.addChild(_d16);
	s.addChild(_d13);
