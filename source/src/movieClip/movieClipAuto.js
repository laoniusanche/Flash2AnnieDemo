...
movieClip.monkey_foot.prototype.initUI=function(){
	...
	var _d1=Flash2x.s({type:0,data:""},{type:0,color:"#FFFFFF"},null);
	var _d2=Flash2x.s({type:0,data:"AGljEQgLAdgQAdQgiA9g4A6QhXBYhhBMIAYCHACXjHQDhgMhOBoQhDg+iFAWABKiFQEFAJh/BmQhZhQi7AoQgIADgJADAiODGIAMCZAliC4QAvALBcAFQAfABAqgDQBRAFB8gjAleFLIgEAFIAAiYAnMEQIAAAAIABAAgAnCB1QANAUAuAdQAPAJAWAJAB4CRIg5AXQgFhFhTgxQhWgwh6AAAhEg+QF5AYjTBtQgUhUj4gIAA9lQQB3gbEZAb"},null,{type:0,color:"#000000",lineWidth:2,caps:"round",joints:"round",miter:"10"});
	...
	var _d6=Flash2x.s({type:0,data:""},{type:0,color:"#FFFFFF"},null);
	...
	var _d8=Flash2x.s({type:0,data:"AA8iiIFKjSACQgcQBdBFhxAoQgFgVgwglACigzQA5AgAHATQCngoigg3AgRApIAAAAAA2ALQAHAIAFAIQAqA9hBAjQgDgVg5g9IBECmQEki7CRiFAAOD2IBJBLAgFD0QAFgEAFgEIAJAKQgKgBgJgBQhigIhpgLIAAAAQhcgLhhgMIAACrAAFDsQAXgOAXgPAjRDqIALCDAnnC/QAtAGAtAF"},null,{type:0,color:"#000000",lineWidth:2,caps:"round",joints:"round",miter:"10"});
	...
	var _d10=Flash2x.s({type:0,data:""},{type:0,color:"#FFFFFF"},null);
	...
	var _d12=Flash2x.s({type:0,data:"AFihGQBhCjifhiQAEgZgag3ADfheQBLCMiihNQAFgdgjg1AA2h3QBaCHing6QAFgggqg3AhYAuQAfAAAhABQAKBHAJA0AhYAjQgQhxgIg2AgYAvQF6AcDxBJAD3iqIFVh9Ak8BDQALBVAHBAAn2BOQgsAGgwAIAhYAtQhxABhyAJQhZAIhiAPAnpEoQgFhigIh4"},null,{type:0,color:"#000000",lineWidth:2,caps:"round",joints:"round",miter:"10"});
	...
	var _d16=Flash2x.s({type:0,data:"ADiilIALBVQApAlA3AAQACgCABgDQATgxgqguAC0i2QAvCMiFg2QgNgGgMgHIgHhoAiXj3QgUBDACBHQAAATACAUAAKjhQAxCSiGgsQgMgEgLgGQANg4gRg3Aimg/IA/gCIA8BiAI/AiIqmhjAKMjIIm6hWAimg/QibAUiTA/QgtAUgsASQAZBoA+BYQAMASANATAl6gDIBVCDAqLBfIBegl"},null,{type:0,color:"#000000",lineWidth:2,caps:"round",joints:"round",miter:"10"});
	...
	var _d18=Flash2x.s({type:0,data:""},{type:0,color:"#FFFFFF"},null);
	...
	var _d20=Flash2x.s({type:0,data:"AC9grQAaA+gFATQCgBIhhiRAhuBcQghgIgdgJAiyiPQgDBvAJBhACOgzQBICUiihIQAFgXgfhOAgZhYQBTC0ikhWQAEgVgfhrAhuBcQAJA/AOBBAITByQkEASl9goAJiilIm/g2AisBLQhsgmhjhAQhMg0hQg3QgWBRgIBUAl+gSQgGBEAEBJAphi2QAmAWAkAa"},null,{type:0,color:"#000000",lineWidth:2,caps:"round",joints:"round",miter:"10"});
